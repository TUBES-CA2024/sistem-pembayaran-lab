                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $mhs['namekelas']; ?></td>
                            <td>
                                <a class="btn-detail text-decoration-none p-2" role="button" href="<?= BASEURL; ?>/Datamahasiswamh/detailkp/<?= $mhs['stambuk'] ?>"><img src="<?= BASEURL ?>/assets/img/detail.png" alt="icon-detail"></a>
                            </td>
                        </tr>
